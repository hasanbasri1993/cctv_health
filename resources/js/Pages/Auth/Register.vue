...
<template>
    <GuestLayout>
        ...
        <h1 class="mb-1 text-[18px] font-semibold text-slate-100">Create account</h1>
        <p class="mb-6 text-[13px] text-slate-500">Register to access CCTV Early Warning</p>
        ...
        <form @submit.prevent="submit" class="space-y-4">
            ...
            <p class="text-center text-[13px] text-slate-500">
                ...
                <Link :href="route('login')" class="text-cyan-400 hover:text-cyan-300">Sign in</Link>
            </p>
        </form>
    </GuestLayout>
</template>
